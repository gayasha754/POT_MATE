...
const NavBar = () => {
  ...
  return (
    <React.Fragment>
      <nav className="bg-emerald-300 border-gray-200 sm:px-4 py-2.5">
        <div className="container px-2.5 flex flex-wrap justify-between items-center mx-auto">
          <Link to="/" className="flex items-center">
            <img
              src={logo}
              className="mr-3 h-15 sm:h-16 rounded-full"
              alt="Flowbite Logo"
            />
          ...
          <div className="flex md:order-1 md:w-4/12">
            ...
            <Link
              to={`/search?val=${search}`}
              className="text-gray-900 flex items-center pl-3"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
