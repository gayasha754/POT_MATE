...
const GET_GARDENTOOLSPRODUCTS_URL = `/root/getgardentoolsproducts`;

const Products_GardenTools = () => {
  const [productList, setProductList] = useState();

  useEffect(() => {
    axios.get(GET_GARDENTOOLSPRODUCTS_URL).then((response) => {
...
export default Products_GardenTools;
