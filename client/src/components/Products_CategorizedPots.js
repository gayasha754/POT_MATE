...
const GET_CATEGORIZEDPRODUCTS_URL = `/root/getcategorizedproducts`;

const Products_CategorizedPots = () => {
  const [productList, setProductList] = useState();

  useEffect(() => {
    axios.get(GET_CATEGORIZEDPRODUCTS_URL).then((response) => {
...
export default Products_CategorizedPots;
