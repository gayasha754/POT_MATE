        ...
        <ul className="space-y-3 mt-14">
          ...
          <li>
            ...
            >
              ...
              <span className="flex-1 ml-3">Stock</span>
            </NavLink>
            <hr className="bg-gray-100 opacity-20" />
          </li>
          <li>
          ...
          <li>
            ...
            >
              ...
              <span className="flex-1 ml-3">Customized Orders</span>
            </NavLink>
            <hr className="bg-gray-100 opacity-20" />
          </li>
          <li>
            ...
            >
              ...
              <span className="flex-1 ml-3">Customers</span>
            </NavLink>
            <hr className="bg-gray-100 opacity-20" />
          </li>
          <li>
