...
const GET_POTMATEPRODUCTS_URL = `/root/getpotmateproducts`;

const Products_PotMates = () => {
  const [productList, setProductList] = useState();

  useEffect(() => {
    axios.get(GET_POTMATEPRODUCTS_URL).then((response) => {
...
export default Products_PotMates;
